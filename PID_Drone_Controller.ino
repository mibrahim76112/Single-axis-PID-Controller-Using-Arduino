...
float pid_d=0;
/////////////////PID CONSTANTS/////////////////
double kp=0.375/2;//0.4
double ki=0.013;//0.03
double kd=0.004/2;//0.005
///////////////////////////////////////////////
...
error = (Acc_rawY/222) - desired_angle;
...
Serial.println("Calculated Angle: ");
Serial.println(Acc_rawY/222);
